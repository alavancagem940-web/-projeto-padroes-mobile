...
const Historico = {
    resultados: [], sequencias: [], sequenciaAtual: [], dadosBrutos: [], baseEstudoQuantidade: 0, baseEstudoBrutosIndice: 0, metadadosTemporais: [], horariosSemDados: [],
    ...
    iniciar() { this.limpar(false); this.horariosSemDados = typeof Armazenamento !== "undefined" ? Armazenamento.obterHorariosSemDados() : []; console.log("Histórico iniciado."); },
    ...
    limpar(apagarStorage=true){ this.resultados=[]; this.sequencias=[]; this.sequenciaAtual=[]; this.dadosBrutos=[]; this.baseEstudoQuantidade=0; this.baseEstudoBrutosIndice=0; this.metadadosTemporais=[]; this.horariosSemDados=[]; if(apagarStorage && typeof Armazenamento!=="undefined") Armazenamento.limpar(); }
};
