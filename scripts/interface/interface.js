...
const Interface = {
        ...
        app.innerHTML=`<div class="painel">
          ...
          <div class="topo">
            <section class="cartao azulb probabilidade"><h2>Probabilidade dos Próximos Resultados</h2><div class="cabecalho-probabilidade"><p><b>Total na Sessão: <span id="total-sessao">0</span></b></p><p>Último registro: <b id="ultimo-registro">-</b></p></div><div class="previsao">
              ...
              <p>⚽ <b>Under 3.5 (filtro):</b> <span id="prev-ou35"></span></p><p>🔥 <b>Over 3.5 independente:</b> <span id="prev-over35"></span></p>
    ...
    atualizar(){
        ...
        document.getElementById('total-sessao').textContent=seq.length; document.getElementById('ultimo-registro').textContent=ultimo?ultimo.placar:'-'; document.getElementById('sequencia-atual').textContent=seq.length;
        ...
        const adapter={exato:MercadoPlacarExato,gols:MercadoGolsExatos,r12:MercadoResultado1X2,bm:MercadoAmbosMarcam,ou05:MercadoOverUnder05,ou15:MercadoOverUnder15,ou25:MercadoOverUnder25,ou35:MercadoOverUnder35,over35:MercadoOver35};
        ...
        document.getElementById('anterior').innerHTML=linha('Placar Exato','exato')+linha('Over / Under 0.5','ou05')+linha('Over / Under 1.5','ou15')+linha('Under 3.5 (filtro)','ou35')+linha('Over 3.5 independente','over35');
        ...
        const paineis = [
          ...
          bloco('🔥 Over 3.5 independente', freqLista('over35', [['MAIS','Mais de 3.5']]), 'over35')
        ];
